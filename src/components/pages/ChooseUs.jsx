    ...
    return (
        <section className="bg-gray-100 py-16">
            <div className="container mx-auto text-center">
                ...
                <p className="text-lg text-gray-700 mb-8 md:mb-10" data-aos="fade-right">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4">
                    {reasons.map((reason, index) => (
                        <li key={index} className="mb-4 sm:mb-6 md:mb-8 lg:mb-10 flex items-center" data-aos="fade-right">
                ...
                <p className="text-lg text-gray-700 mt-8 md:mt-12" data-aos="fade-left">
